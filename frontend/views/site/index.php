<div class="container">
    <div class="owl-carousel owl-slider" id="owl-carousel-slider" data-inner-pagination="true" data-white-pagination="true" data-nav="false">
        <div>
            <div class="bg-holder">
                <img src="img/1200x480.png" alt="Image Alternative text" title="Branding  iPad Interactive Design" />
                <div class="bg-mask"></div>
                <div class="bg-front vert-center text-white text-center">
                    <h2 class="text-hero">New Bloke Collection</h2>
                    <p class="text-bigger">Elit primis iaculis arcu quam justo per</p>
        ...
        <div>
            <div class="bg-holder">
                <img src="img/1200x480.png" alt="Image Alternative text" title="Hot mixer" />
                <div class="bg-mask"></div>
                <div class="bg-front vert-center text-white text-center">
                    <h2 class="text-hero">Modern DJ Sets</h2>
                    <p class="text-bigger">Primis tempus ad iaculis cursus condimentum nullam</p>
                    <p class="text-hero">Save up to 50%</p><a class="btn btn-lg btn-ghost btn-white btn-lg" href="#">Shop Now</a>
                </div>
            </div>
        </div>
        <div>
            <div class="bg-holder">
                ...
                <div class="bg-front vert-center text-white text-center">
                    ...
                    <p class="text-bigger">Pretium dui id sit lacus duis dignissim</p>
                    <p class="text-hero">Save up to 50%</p><a class="btn btn-lg btn-ghost btn-white btn-lg" href="#">Shop Now</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="product-thumb">
                        ...
                        <div class="product-inner">
                            ...
                            <p class="product-desciption">Ridiculus dictum aliquam vitae sollicitudin lacinia nisl platea</p>
